...
Backend: FastAPI (Python) Frontend: Streamlit AI Engine: Ollama (Mistral or LLaMA3) Database: SQLite Vector Store: FAISS Deployment: Render, Railway, or local environment
